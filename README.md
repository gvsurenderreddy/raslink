...
Ok... I warned you!
To switch to the development version, do the following:
...
When you file your bug, please mention that you are using the develop branch. Bugs in the master branch that are critical will always get
fixed first, but the develop branch will always have the latest toys!
