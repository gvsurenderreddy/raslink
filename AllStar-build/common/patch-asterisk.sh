...
sed -i '/ \*  version/c\ \*  version 17.10 10\/01\/2017' ./apps/app_rpt.c
sed -i '/static  char \*tdesc \= "Radio Repeater \/ Remote Base  version/c\static  char \*tdesc \= "Radio Repeater \/ Remote Base  version 17.10 10\/01\/2017";' ./apps/app_rpt.c
...
sed -i 's/define	QUEUE_SIZE	10/define	QUEUE_SIZE	3/' ./channels/chan_usbradio.c
echo "Done"
exit 0
